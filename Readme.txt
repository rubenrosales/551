...
-----------------------
There are total three Python files including 'main.py', 'solution.py' and 'helper.py'. You need to complete 'solution.py' and 'main.py' files following the given instruction. The 'main.py' is used to test your solution. 

The 'helper.py' includes all the helper functions for the assignment, like load data, extract features, etc. 

Notes: Do not change anything in 'helper,py' files. Only try to complete your code in 'solution.py' and 'main.py' file and keep function names and parameters unchanged.  


Submitting requirements
-----------------------
Please submit a write-up to briefly report your results before lecture and the ‘solution.py’ and 'main.py' files to the BeachBoard.
